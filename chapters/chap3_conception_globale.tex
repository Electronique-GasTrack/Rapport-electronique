...
Le système s'articule autour de deux entités distinctes :
...
Cette approche modulaire offre une grande flexibilité : le système est parfaitement fonctionnel en mode "local" (capteur + afficheur) pour les utilisateurs sans internet.
...
\subsection{Choix du capteur ultrasonore}
...
\begin{itemize}
    ...
    \item \textbf{Indépendance} : Système fonctionnel même sans connexion Internet/infrastructure réseau
...
En local, la communication LoRa utilise des identifiants anonymes, ne transmettant aucune donnée personnelle, uniquement des niveaux techniques.
