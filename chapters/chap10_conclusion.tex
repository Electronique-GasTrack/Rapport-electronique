...
\begin{itemize}
    ...
    \item \textbf{Supervision locale :} L'interface dédiée (écran LCD) offre une lecture claire et immédiate pour l'utilisateur.
...
Sur le plan logiciel, le développement d'une application web et mobile constitue la prochaine étape logique. Cela permettrait une gestion multi-utilisateurs, l’intégration de notifications intelligentes, ainsi qu’un système avancé d’analyse de consommation via le cloud.
