\chapter{Développement de l'Application Mobile}
\label{chap:application}

Ce chapitre présente la conception et le développement de l'application mobile GasTrack.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{chapters/diagramme_classe.png}
    \caption{Diagramme de classe}
    \label{fig:diagramme_classe}
\end{figure}

Ce modèle permet de structurer les informations échangées entre le backend cloud, l’application mobile et l’utilisateur.
...
\subsubsection{Classe \texttt{Passerelle}}

La classe \texttt{Passerelle} représente l'interface avec l'infrastructure LoRa.

\textbf{Rôle :}
Elle gère l'identification des dispositifs LoRa et la récupération des données depuis le serveur.

\textbf{Responsabilités principales :}
\begin{itemize}
    \item Authentification auprès de l'API du backend
    \item Synchronisation des données des capteurs
\end{itemize}


\subsubsection{Classe \texttt{Utilisateur}}

La classe \texttt{Utilisateur} représente l’utilisateur final de l’application mobile.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{chapters/usecase.png}
...
Le tableau suivant présente une synthèse des principaux cas d’utilisation de l’application mobile.
...
\begin{enumerate}[leftmargin=*, nosep]
    \item L'utilisateur ouvre l'application
...
\textbf{UC4:} Ajouter un nouveau capteur & 
Code ID du capteur disponible & 
\begin{enumerate}[leftmargin=*, nosep]
    \item Appui sur "Ajouter dispositif"
    \item Saisie de l'ID unique du capteur LoRa
    \item Vérification auprès du serveur
    \item Association au compte utilisateur
    \item Confirmation visuelle
\end{enumerate} & 
\textbf{A1:} ID invalide → Message d'erreur & 
Capteur ajouté au parc \\
\hline
...
Cette section décrit le parcours utilisateur au sein de l’application mobile \textit{GasTrack}.  
...
L'utilisation d'une architecture cloud simplifie grandement le parcours utilisateur en supprimant les étapes techniques de connexion Bluetooth et d'appairage à chaque utilisation. L'information est disponible immédiatement au lancement de l'application.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{chapters/activite_historique.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{chapters/activite_niveau_gaz.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{chapters/activite_prediction.png}
