...
\begin{itemize}
    ...
    \item L’application web nécessite une connexion internet permanente pour accéder aux données
    et ne fonctionne pas en mode hors-ligne.
...
\begin{itemize}
    ...
    \item Développement d'une Progressive Web App (PWA) pour permettre une installation
    sur mobile et un fonctionnement partiel hors-ligne.
