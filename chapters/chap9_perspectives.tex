...
\begin{itemize}
    ...
    \item L’application mobile dépend de la connexion Bluetooth et ne permet pas une surveillance
    totalement distante en temps réel.
    \item Le backend reste basique et n’intègre pas encore de mécanismes avancés d’analyse
    ou d’optimisation des données.
\end{itemize}
...
\begin{itemize}
    ...
    \item Mise en place d’une synchronisation cloud automatique pour un suivi à distance
    sans dépendre uniquement du Bluetooth.
    \item Ajout de notifications intelligentes (alertes personnalisées, prévisions avancées).
    \item Amélioration de l’interface utilisateur pour une meilleure expérience (UX/UI).
    \item Sécurisation renforcée des données échangées entre l’application et le backend.
\end{itemize}
...
\begin{itemize}
    ...
    \item Développement d’une application mobile stable et déployée sur les stores officiels.
