...
Le capteur a été fixé avec un gel de couplage acoustique pour optimiser la transmission des ondes. Après une calibration initiale (vide/plein), nous avons réalisé une série de 20 mesures à différents niveaux de remplissage connus, en comparant systématiquement les résultats avec une pesée de référence.
