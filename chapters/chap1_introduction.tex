...
\subsection{Objectifs spécifiques(OS)}
...
\subsection*{Phase 2 : Développement matériel (8 semaines)}

\subsection*{Phase 3 : Tests et validation (2 semaines)}

\subsection*{Phase 4 : Documentation (2 semaines)}
