...
\begin{quote}
    \textit{Concevoir, réaliser et valider un système électronique intelligent et connecté permettant la mesure non-intrusive du niveau de gaz butane dans une bouteille domestique, avec affichage local et accès à distance via une application web.}
\end{quote}
...
\subsubsection{OS3 : Application web connectée}

Développer une application web offrant :
\begin{itemize}
    ...
    \item Notifications ou alertes visuelles (niveau bas, anomalies détectées).
\end{itemize}
