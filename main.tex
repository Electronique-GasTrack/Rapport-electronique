...
\include{chapters/chap3_conception_globale}
\include{chapters/chap4_appareil}
\include{chapters/chap5_application}
\include{chapters/chap7_tests}
\include{chapters/chap8_difficultes}
\include{chapters/chap9_perspectives}
\include{chapters/chap10_conclusion}
...
\item Google. \textit{Flutter Documentation}.  
Disponible sur : \url{https://docs.flutter.dev} (consulté en janvier 2026).

\item VMware. \textit{Spring Boot Reference Documentation}.  
Disponible sur : \url{https://docs.spring.io/spring-boot/docs/current/reference/html/} (consulté en janvier 2026).

\item Arduino. \textit{Arduino Official Documentation}.  
Disponible sur : \url{https://docs.arduino.cc} (consulté en janvier 2026).

\item Bluetooth SIG. \textit{Bluetooth Low Energy (BLE) Core Specification}.  
Disponible sur : \url{https://www.bluetooth.com/specifications/specs/core-specification/} (consulté en janvier 2026).
...
\item Render. \textit{Deploying Spring Boot Applications}.  
Disponible sur : \url{https://render.com/docs/deploy-spring-boot} (consulté en janvier 2026).

\item Flutter Community. \textit{flutter\_blue\_plus Package Documentation}.  
Disponible sur : \url{https://pub.dev/packages/flutter_blue_plus} (consulté en janvier 2026).

\item Google. \textit{Google Identity Platform Documentation}.  
Disponible sur : \url{https://developers.google.com/identity} (consulté en janvier 2026).

\item Kinsler, L. E., Frey, A. R., Coppens, A. B., \& Sanders, J. V.  
\textit{Fundamentals of Acoustics}. John Wiley \& Sons, 2000.

\item Net Ninja. \textit{Flutter Tutorial for Beginners}. YouTube Playlist.  
Disponible sur : \url{https://www.youtube.com/playlist?list=PL4cUxeGkcC9i9Ae2D9Ee1RvylH38dKuET} (consulté en janvier 2026).

\item Andreas Spiess. \textit{Bluetooth Low Energy with Arduino}. YouTube Video.  
Disponible sur : \url{https://www.youtube.com/watch?v=5zI0ydQ0n4Y} (consulté en janvier 2026).
...
\item World Health Organization (WHO). \textit{Household Air Pollution and Health}.  
Disponible sur : \url{https://www.who.int/news-room/fact-sheets/detail/household-air-pollution-and-health} (consulté en janvier 2026).
